...
const Button = ({ isSignedIn, signin }) =>{
    if (isSignedIn) {
     return(
        <div>
            <Link to="/">
                <button onClick={signin} type="buton" className="f6 grow no-underline br-pill ph3 pv2 mb2 dib white bg-near-black ma2 border-button">Sign Out</button>
            </Link>
            <Link to="/profile">
